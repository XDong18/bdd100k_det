...
if __name__ == "__main__":
    ...
    with open(os.path.join('bdd100k_faster_rcnn_R_101_FPN_1x', 'inference_test/coco_instances_results.json')) as f:
    ...
    coco_temp_result_file = os.path.join(temp_dir, 'bdd100k_faster_rcnn_R_101_FPN_1x.json')
    with open(coco_temp_result_file, 'w') as f:
        json.dump(new_result_data, f)
    
    test_json_name = 'bdd100k' + '-' 'detectron2' + '-' + 'faster_rcnn_r101_fpn-1x' + '-' + 'results' + '.json'
