...
def setup(args):
    ...
    # set config file
    cfg.merge_from_file(model_zoo.get_config_file("configs/BDD100K-Detection/faster_rcnn/faster_rcnn_X_101_32x8d_FPN_1x_crop.yaml"))
    cfg.DATASETS.TRAIN = ("bdd100k_train",)
    cfg.DATASETS.TEST = ("bdd100k_val",)
    # cfg.MODEL.WEIGHTS = model_zoo.get_checkpoint_url("COCO-Detection/faster_rcnn_X_101_32x8d_FPN_3x.yaml")  # Let training initialize from model zoo


    cfg.OUTPUT_DIR = './bdd100k_faster_rcnn'
